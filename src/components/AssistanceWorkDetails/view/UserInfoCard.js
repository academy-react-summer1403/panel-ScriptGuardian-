        ...
        <CardBody>
            ...
            <div className="d-flex align-items-center flex-column">
              ...
              <div className="d-flex flex-column align-items-center text-center">
                <div className="user-info">
                  <h4>{data?.worktitle ? data?.worktitle : ""}</h4>
          ...
          <div className="info-container">
            <ul className="list-unstyled">
              <li className="mb-75">
                <span className="fw-bolder me-25"> نام assistanceName:</span>
                <NavLink to={`/UsersPage/${data?.userId}`}>
                  {data?.assistanceName ? data?.assistanceName : ""}{" "}
                </NavLink>
              </li>
              <li className="mb-75">
                <span className="fw-bolder me-25"> نام دوره:</span>
                <NavLink to={`/CourseListPage/${data?.courseId}`}>
              ...
              <li className="mb-75">
                <span className="fw-bolder me-25"> تاریخ ساخت :</span>
                <span>
                  {data?.inserDate ? convertIsoToJalali(data?.inserDate) : ""}{" "}
                </span>
              </li>
              <li className="mb-75">
                <span
                ...
                <span>{data?.workDescribe ? data?.workDescribe : ""} </span>
              </li>
            </ul>
          </div>
